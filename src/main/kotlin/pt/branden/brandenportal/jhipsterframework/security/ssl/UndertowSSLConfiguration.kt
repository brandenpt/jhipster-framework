...
package pt.branden.brandenportal.jhipsterframework.security.ssl
 ...
 *
 * @see <a href="https://github.com/ssllabs/research/wiki/SSL-and-TLS-Deployment-Best-Practices#25-use-forward-secrecy"
 * target="_blank">More explanation on perfect forward secrecy</a>
 *
 * @param factory a [org.springframework.boot.web.embedded.undertow.UndertowServletWebServerFactory] object.
 *
 */
@Configuration
@ConditionalOnClass(
...
open class UndertowSSLConfiguration(private val factory: UndertowServletWebServerFactory) {
    init {
    ...
    private fun configuringUserCipherSuiteOrder() {
        ...
        factory.addBuilderCustomizers(UndertowBuilderCustomizer { builder: Undertow.Builder ->
            builder.setSocketOption(UndertowOptions.SSL_USER_CIPHER_SUITES_ORDER, true)
        })
    }
}
